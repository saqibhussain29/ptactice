    ...
    <div class="container mt-6   form-section ">
        ...
        <form action="hello.php" method="POST">
            ...
            <div class="form-group  mb-6 ">
                <label for="exampleInputEmail1   " class="hidden"></label>
                <input type="hidden" name="std_id" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $data[0] ?>" />

            </div>
            <!-- <div  class="margin-6"> -->
            <div class="form-group mb-6  ">
                <label class="form-label" for="exampleInputEmail1">NAME</label>
                <input type="text" name="std_name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $data[1]?>" />
            ...
            <div class="form-group  mb-6 ">
                ...
                <input type="TEXT" name="english" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $data[2]    ?>" />
                <span class="text-danger">
                    <?php if (isset($errors['english'])) echo $errors['english']; ?></span><br><br>
            </div>
            <div class="form-group  ">
                <label for="exampleInputEmail1">MATHS MARKS</label>
                <input type="text" name="maths" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $data[3]   ?>" />
            ...
            <div class="form-group ">
                ...
                <input type="text" name="science" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $data[4]    ?>" />
